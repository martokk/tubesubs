...
@patch("python_fastapi_stack.core.notify.settings.TELEGRAM_API_TOKEN", "valid_token")
@patch("python_fastapi_stack.core.notify.settings.TELEGRAM_CHAT_ID", 123)
@patch("python_fastapi_stack.core.notify.settings.NOTIFY_TELEGRAM_ENABLED", True)
...
@patch("python_fastapi_stack.core.notify.settings.NOTIFY_TELEGRAM_ENABLED", True)
@patch("python_fastapi_stack.core.notify.settings.TELEGRAM_CHAT_ID", 0)
async def test_send_telegram_message_settings_not_set() -> None:
    """
    Test that the logger is called when the settings are not set.
    """
    with patch("python_fastapi_stack.core.notify.logger") as mock_logger:
...
@patch("python_fastapi_stack.core.notify.settings.EMAILS_ENABLED", True)
@patch("python_fastapi_stack.core.notify.settings.NOTIFY_EMAIL_ENABLED", True)
@patch("python_fastapi_stack.core.notify.settings.NOTIFY_TELEGRAM_ENABLED", True)
...
@patch("python_fastapi_stack.core.notify.settings.TELEGRAM_CHAT_ID", 123)
@patch("python_fastapi_stack.core.notify.settings.EMAILS_ENABLED", True)
@patch("python_fastapi_stack.core.notify.settings.SMTP_USER", "user")
@patch("python_fastapi_stack.core.notify.settings.SMTP_PASSWORD", "password")
...
@patch("python_fastapi_stack.core.notify.settings.EMAILS_ENABLED", False)
