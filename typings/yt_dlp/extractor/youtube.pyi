...
class YoutubeBaseInfoExtractor(InfoExtractor):
    ...
    _SAPISID = ...
    def extract_yt_initial_data(self, item_id, webpage, fatal=...): # -> object | dict[Unknown, Unknown] | Any | None:
        ...
    ...
    def generate_api_headers(self, *, ytcfg=..., account_syncid=..., session_index=..., visitor_data=..., identity_token=..., api_hostname=..., default_client=...): # -> dict[str, str | Unknown | Any | tuple[str | Unknown, ...] | object | list[Unknown] | dict[Unknown, Unknown] | None]:
        ...
