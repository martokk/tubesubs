...
def sanitize_open(filename, open_mode): # -> tuple[BinaryIO | TextIO, Unknown] | tuple[locked_file | Unknown, Unknown | str] | None:
...
def get_exe_version(exe, args=..., version_re=..., unrecognized=...): # -> str | bytes | dict[Unknown, Unknown] | Any | Literal[False]:
...
class PlaylistEntries:
    ...
    def get_requested_items(self): # -> Generator[tuple[int, Unknown | Any], Any, None]:
        ...

    def get_full_count(self): # -> int | Unknown | None:
        ...

    def __getitem__(self, idx): # -> Generator[tuple[int, Unknown | Any], Any, None]:
        ...
...
def mimetype2ext(mt, default=...): # -> object | list[Unknown] | dict[Unknown, Unknown] | str | None:
    ...

def ext2mimetype(ext_or_url): # -> str | None:
    ...

def parse_codecs(codecs_str): # -> dict[Unknown, Unknown] | dict[str, Any | str | None] | dict[str, Any]:
    ...

def get_compatible_ext(*, vcodecs, acodecs, vexts, aexts, preferences=...): # -> str:
    ...

def urlhandle_detect_ext(url_handle, default=...): # -> str | Any | object | list[Unknown] | dict[Unknown, Unknown] | None:
    ...
...
def match_filter_func(filters, breaking_filters=...): # -> ((info_dict: Unknown, incomplete: bool = False) -> (object | str | None)) | None:
    ...
...
class download_range_func:
    ...
    def __call__(self, info_dict, ydl): # -> Generator[dict[str, int] | dict[str, Unknown | Any], Unknown, None]:
        ...
...
def traverse_obj(obj, *paths, default=..., expected_type=..., get_all=..., casesense=..., is_user_input=..., traverse_string=...): # -> list[Unknown] | object | dict[Unknown, Unknown] | None:
    """
...
def traverse_dict(dictn, keys, casesense=...): # -> list[Unknown] | object | dict[Unknown, Unknown] | None:
    ...

def get_first(obj, keys, **kwargs): # -> list[Unknown] | object | dict[Unknown, Unknown] | None:
    ...
...
class Config:
    ...
    @property
    def all_args(self): # -> Generator[Unknown | Any, Unknown, None]:
        ...
...
def orderedSet_from_options(options, alias_dict, *, use_regex=..., start=...): # -> Generator[Any | Unknown, Any, None] | list[Unknown]:
    ...
